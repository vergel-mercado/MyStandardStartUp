...
public class CallHttpGet extends AsyncTask<String, String, String> {
    ...
    public CallHttpGet(Context c, ExecuteAsyncTask listener, List<NameValuePair> parameters, String url, String title){
        this.c = c;
